...
class APIHandler {
  ...
  static Future<List<ProductsModel>> getAllProductsByLocation(
      {required String location}) async {
    List temp = await getData(
      target: "products-by-location?location=$location"
    );
    return ProductsModel.productsFromSnapshot(temp);
  }
  ...
  static Future<List<CategoriesModel>> getAllLocations() async {
    List temp = await getData(target: "locations");
    return CategoriesModel.categoriesFromSnapshot(temp);
  }
